(function(){
    ...
    app.controller('PersonListController', ['$scope', '$log', 'People', 'PeopleService', 'Person', '$rootScope',
                                    function($scope, $log, People, PeopleService, Person, $rootScope){
    ...
    app.controller('PersonDetailsController', ['$scope', '$log', 'Person', 'PeopleService', '$rootScope',
                                        function($scope, $log, Person, PeopleService, $rootScope){
